...
# 为了在老版本的Python代码中兼顾新特性的一种方法。从python2.1开始，当一个新的语言特性首次出现在发行版中时，如果该新特性与旧版本的python不兼容，
# 则该新特性默认会被禁用。要想启用这个新特性，必须使用 "from __future__import xxx" 进行导入。
# 示例：print语句
...
# https://www.cnblogs.com/AliceYing/p/15094706.html
